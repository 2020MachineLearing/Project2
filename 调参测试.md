...
![](D:\lab+project\ml\project2\asset\难以收敛.jpg)
...
![batch影响1](D:\lab+project\ml\project2\asset\batch影响1.png)



![batch影响2](D:\lab+project\ml\project2\asset\batch影响2.jpg)
...
![dialoglen-bleu](D:\lab+project\ml\project2\asset\dialoglen-bleu.png)

绘制dialoglen与time_consumed关系图：

![dialoglen-time](D:\lab+project\ml\project2\asset\dialoglen-time.png)
...
![dropout-bleu](D:\lab+project\ml\project2\asset\dropout-bleu.png)

绘制dropout与time_consumed关系图：

![dropout-time](D:\lab+project\ml\project2\asset\dropout-time.png)
...
![n_layers-bleu](D:\lab+project\ml\project2\asset\n_layers-bleu.png)

绘制n_layers与time_consumed关系图：

![n_layers-time](D:\lab+project\ml\project2\asset\n_layers-time.png)
...
![IO溢出](D:\lab+project\ml\project2\asset\IO溢出.png)
...
![内存溢出](D:\lab+project\ml\project2\asset\内存溢出.png)

原因应该是内存利用率提升，但是内存容量不足了

绘制batch_size与bleu关系图：

![batch-bleu](D:\lab+project\ml\project2\asset\batch-bleu.png)

绘制batch_size与time_consumed关系图：

![batch-time](D:\lab+project\ml\project2\asset\batch-time.png)